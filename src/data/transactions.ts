...
export const TRANSACTIONS: Transaction[] = [
  ...
  { id: 'TXN-050', timestamp: '2025-01-27T15:45:00', amount: 1300,  channel: 'UPI',              type: 'Debit',  payeeName: 'Meesho Seller',        payeeId: 'meesho@paytm',        isNewPayee: false, merchantCategory: 'E-Commerce', customerAge: 340,  city: 'Lucknow',   isFlaggedGT: false },
   // ── Extra legitimate IMPS sub-₹500 debits — triggers RULE-002 as false positives (by design) ──
  { id: 'TXN-051', timestamp: '2025-01-10T08:12:00', amount: 180,   channel: 'IMPS',             type: 'Debit',  payeeName: 'Metro Rail Canteen',    payeeId: 'metrocanteen@sbi',    isNewPayee: false, merchantCategory: 'Utility',    customerAge: 730,  city: 'Chennai',   isFlaggedGT: false },
  { id: 'TXN-052', timestamp: '2025-01-16T13:05:00', amount: 430,   channel: 'IMPS',             type: 'Debit',  payeeName: 'Koramangala Tiffin',   payeeId: 'tiffin@ucobank',      isNewPayee: false, merchantCategory: 'E-Commerce', customerAge: 510,  city: 'Bengaluru', isFlaggedGT: false },
  { id: 'TXN-053', timestamp: '2025-01-20T12:45:00', amount: 250,   channel: 'IMPS',             type: 'Debit',  payeeName: 'Office Stationery Mart',payeeId: 'stationery@pnb',      isNewPayee: false, merchantCategory: 'E-Commerce', customerAge: 840,  city: 'Noida',     isFlaggedGT: false },
  { id: 'TXN-054', timestamp: '2025-01-24T19:30:00', amount: 380,   channel: 'IMPS',             type: 'Debit',  payeeName: 'Chai Point Express',    payeeId: 'chaipoint@icici',     isNewPayee: false, merchantCategory: 'E-Commerce', customerAge: 220,  city: 'Hyderabad', isFlaggedGT: false },
